<!-- Social icons -->
<div class="bg-danger p-1 ps-3 fs-6 text-md-start text-center">
    <a href="https://facebook.com/4evergaming.com.ar" target="_blank" class="text-decoration-none text-dark ms-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
        </svg>
    </a>

    <a href="https://twitter.com/4evergamingOK" target="_blank" class="text-decoration-none text-dark ms-1">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
            <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z"/>
        </svg>
    </a>

    <a href="https://instagram.com/4evergaming.com.ar" target="_blank" class="text-decoration-none text-dark ms-1">
    ...
    <a href="https://www.youtube.com/channel/UCOGkRP2uNamUAsWnYUPd2xg" target="_blank" class="text-decoration-none text-dark ms-1">
    ...
    <a href="https://wa.me/5491124002295" target="_blank" class="text-decoration-none text-dark ms-1">
    ...
    <span class="float-md-end me-3">
        <a href="tel:+54112400-2295" class="text-decoration-none text-dark ms-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-headset" viewBox="0 0 16 16">
                    <path d="M8 1a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a6 6 0 1 1 12 0v6a2.5 2.5 0 0 1-2.5 2.5H9.366a1 1 0 0 1-.866.5h-1a1 1 0 1 1 0-2h1a1 1 0 0 1 .866.5H11.5A1.5 1.5 0 0 0 13 12h-1a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1h1V6a5 5 0 0 0-5-5z"/>
            </svg> 
            <span class="d-none d-sm-inline-block text-decoration-none text-dark"> +54 11 2400-2295 </span>
        </a>
                
        <a href="mailto:ventas@4evergaming.com.ar" class="text-decoration-none text-dark ms-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
            </svg> 
            <span class="d-none d-sm-inline-block text-decoration-none text-dark"> ventas@4evergaming.com.ar </span>
        </a>
    </span>
</div>
...
<nav class="navbar navbar-dark navbar-expand-lg bg-dark shadow">
    <div class="container-fluid">
        ...
        <div class="float-end text-success">
            ...
            <a href="https://status.4evergaming.com.ar" target="_blank" class="text-decoration-none text-success me-3">
                En línea (10 ms) 
            </a>
