    ...
    <div class="d-md-flex d-inline">
      ...
      <div class="col-md text-md-start text-center pt-5">
        ...
        <h5> 
          ...
          • Interfaz web TCAdmin 
        </h5> 

        <a href="https://clientes.4evergaming.com.ar/store/counter-strike-go/counter-strike-global-offensive-128-tickrate?currency=2" target="_blank" class="btn btn-danger"> 
