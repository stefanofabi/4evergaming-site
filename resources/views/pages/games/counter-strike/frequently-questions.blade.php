...
<div class="accordion mt-2 ms-md-5 me-md-5" id="accordionExample">
    ...
    @include('pages.games.counter-strike.accordion-frequently-questions.how-can-configure-my-server')
    @include('pages.games.counter-strike.accordion-frequently-questions.backup-policy')
    @include('pages.games.counter-strike.accordion-frequently-questions.need-resources-for-my-server')
</div>
