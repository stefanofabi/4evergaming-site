        ...
        <div class="card mt-3" style="width: 18rem;">
          ...
          <ul class="list-group list-group-flush">
            <li class="list-group-item"> 
              ...
              Billeteras virtuales <span class="badge text-bg-danger"> 5% descuento </span> 
            </li>
            ...
            <li class="list-group-item"> 
              ...
              <a class="text-decoration-none text-dark" href="{{ asset('transferencia-electronica-de-fondos.pdf') }}" target="_blank"> 
                Transferencia CBU 
              </a> 
              <span class="badge text-bg-danger"> 5% descuento </span> 
            </li>
            ...
            <li class="list-group-item"> 
              <a class="text-decoration-none text-dark" href="https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=2c938084837e83a40183822347fc0318" target="_blank"> 
