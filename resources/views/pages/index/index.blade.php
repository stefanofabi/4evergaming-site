  ...
  function getGameState(game, ip, port, index)
  {
    ...
    $.ajax({
        ...
        success: function (response) {
          ...
          $("#"+game+"-name-"+index).html(removeTags(server.var.gq_hostname));
