    <div class="accordion mt-3" id="topServers">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header">
                <button class="accordion-button fw-bold @if ($rank != 1) collapsed @endif fs-4 text-nowrap" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $rank }}" aria-controls="collapse{{ $rank }}">
                ...
                <div class="accordion-body">
                    ...
                    <div class="row">
                        <div class="col-md mt-md-1">
                            ...
                            <div class="fs-5 text-nowrap"> <strong> Nombre: </strong> <span class="fw-bold text-{{ $podiums[$rank - 1] }}"> {{ $server->hostname }} </span> </div>
                        ...
                        <div class="col-md mt-md-1 mt-3 text-center">
                            <h3> ➡️ Mapa actual </h3>
                            <div> 
