    ...
    <div class="card-header">
        <div class="row p-1">
            ...
            <div class="col-md-6 fst-italic text-md-end">
                <div> Ultima actualización hace <span
                        id="lastUpdate">{{ \Carbon\Carbon::now()->diffInMinutes($server->updated_at) }} </span> minutos
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-8 mt-md-1">
                ...
                <div class="fs-5"> <strong> Juego: </strong> <a
                        href="{{ route('servers/search', ['game' => $server->game->protocol]) }}">
                        {{ $server->game->name }} </a> </div>
                ...
                <div class="fs-5 mt-3">
                    @auth
                        ...
                        @else
                            <div> <a class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                    data-bs-target="#claimServerModal"> Reclamar propiedad </a> </div>
                        @endif
                    @endauth
                </div>
            </div>
            ...
            <div class="col-md mt-md-1 mt-3 text-md-center">
                ...
                <img class="img-fluid rounded mt-1"
                    ...
                    alt="{{ $server->map }}" title="{{ $server->map }}" id="map" />
