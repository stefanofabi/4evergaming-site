    ...
    <table class="table table-light table-striped table-hover mt-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <a class="text-decoration-none text-dark ms-2 text-nowrap" href="{{ route('servers/info', ['ip' => $server->ip, 'port' => $server->port]) }}" title="{{ $server->hostname }}"> {{ substr($server->hostname, 0, 80) }} </a> </td>
