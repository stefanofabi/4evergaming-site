                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-lg rounded">
                        <a href="{{ route('communities/show', $community->id) }}">
                            <img src="{{ asset('storage/communities/' . $community->logo) }}?t={{ strtotime($community->updated_at) }}"
                                class="card-img-top" alt="{{ $community->name }}">
                        </a>
                        ...
                        <div class="card-body d-flex flex-column mt-3">
                            ...
                            <div class="social-icons mt-3">
                                ...
                                @if ($community->instagram)
                                    <a href="https://www.instagram.com/{{ $community->instagram }}" target="_blank"
                                        title="Instagram">
                                ...
                                @if ($community->tiktok)
                                    <a href="https://www.tiktok.com/{{ '@' . $community->tiktok }}" target="_blank"
                                        title="TikTok">
                                ...
                                @if ($community->youtube)
                                    <a href="https://www.youtube.com/{{ $community->youtube }}" target="_blank"
                                        title="YouTube">
